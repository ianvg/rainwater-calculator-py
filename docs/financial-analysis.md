...
The tab reports average annual rainwater supplied, gross annual utility savings, annual maintenance, net annual savings, net installed cost after incentives, simple payback, and undiscounted net benefit over the analysis period. Payback displays **Not achieved** when net annual savings are zero or negative.
