...
Double-click a collection-surface row to open the edit dialog. Modify its name, area, surface type, or runoff coefficient as applicable.
...
A higher coefficient produces more calculated collection for the same rainfall and area. Consider surface absorption, wetting loss, leakage, first-flush diversion, debris, slope, and conveyance losses when selecting a value.
