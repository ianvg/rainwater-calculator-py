...
The daily analysis is a primary-tank storage balance. It does not apply graphical-system topology, pump capacities, filtration recovery, booster-tank controls, or municipal-backup flow. Those constraints are evaluated by the optional hourly simulation.
