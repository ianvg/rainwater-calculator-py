...
The application is organized into tabs for project inputs, rainfall importing, demand, collection surfaces, analysis settings, and results. The exact tabs visible may vary as the application develops.
